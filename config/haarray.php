...
return [
    ...
    */
    ...
    'root_admin_email' => env('HAARRAY_ROOT_ADMIN_EMAIL', 'prateekbhujelpb@gmail.com'),
    'terms_version' => env('HAARRAY_TERMS_VERSION', '2026-02-23'),
    ...
    */
    'global_search' => [
        ...
        'models' => [
            ...
            [
                'key' => 'ipo',
                'model' => \App\Models\IPO::class,
                'id' => 'id',
                'title' => 'company_name',
                'subtitle' => 'symbol',
                'search' => ['company_name', 'symbol', 'status'],
                'route' => 'portfolio.index',
                'permission' => 'view portfolio',
